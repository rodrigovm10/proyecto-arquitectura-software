...
export default function UpdateInfoPersonal({datosInforPersonal, setEDatosInforPersonal}) {
    ...
    const initialFormData = {
        ...
        telefono: datosInforPersonal.telefono || '', // Cambiado a string para manejar números
        ...
        codigoPostal: datosInforPersonal.codigoPostal || '', // Cambiado a string para manejar números
      };
