...
const RegistroHabilidades = ({ habilidades, setHabilidades }) => {
  ...
  const [habilidadesBlandasSeleccionadas, setHabilidadesBlandasSeleccionadas] =
    useState([]);
  const [habilidadBlandaSeleccionada, setHabilidadBlandaSeleccionada] =
    useState("");
  const [
    habilidadesTecnicasSeleccionadas,
    setHabilidadesTecnicasSeleccionadas,
  ] = useState([]);
  const [habilidadTecnicaSeleccionada, setHabilidadTecnicaSeleccionada] =
    useState("");
