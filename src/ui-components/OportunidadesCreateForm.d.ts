...
export declare type OportunidadesCreateFormInputValues = {
    nombre?: string;
    descripcion?: string;
    numeroPlazas?: number;
    area?: string;
...
export declare type OportunidadesCreateFormValidationValues = {
...
export declare type OportunidadesCreateFormOverridesProps = {
    OportunidadesCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type OportunidadesCreateFormProps = React.PropsWithChildren<{
    overrides?: OportunidadesCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: OportunidadesCreateFormInputValues) => OportunidadesCreateFormInputValues;
    onSuccess?: (fields: OportunidadesCreateFormInputValues) => void;
    onError?: (fields: OportunidadesCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: OportunidadesCreateFormInputValues) => OportunidadesCreateFormInputValues;
    onValidate?: OportunidadesCreateFormValidationValues;
} & React.CSSProperties>;
export default function OportunidadesCreateForm(props: OportunidadesCreateFormProps): React.ReactElement;
