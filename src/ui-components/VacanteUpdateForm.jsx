...
export default function VacanteUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setSalario(cleanValues.salario);
    ...
    setDiscapacidadAcept(cleanValues.discapacidadAcept ?? []);
    setCurrentDiscapacidadAceptValue("");
    setArea(cleanValues.area);
    setTipoEmpleo(cleanValues.tipoEmpleo);
    setCausaVacante(cleanValues.causaVacante);
    setDispViajar(cleanValues.dispViajar);
    setDispRadicar(cleanValues.dispRadicar);
    setNivelPuesto(cleanValues.nivelPuesto);
    setExperiencia(cleanValues.experiencia);
    setEscolaridad(cleanValues.escolaridad);
    setVigenciaVacante(cleanValues.vigenciaVacante);
    ...
    setTipoCotrato(cleanValues.tipoCotrato);
    setModalidad(cleanValues.modalidad);
    setTipoLicencia(cleanValues.tipoLicencia);
    setContratoDirecto(cleanValues.contratoDirecto);
    setSalarioMax(cleanValues.salarioMax);
    setSalarioMin(cleanValues.salarioMin);
    setPeriodoPago(cleanValues.periodoPago);
    setTipoSueldo(cleanValues.tipoSueldo);
    setCorreoContactoDirecto(cleanValues.correoContactoDirecto);
    setTelefonoContactoDirecto(cleanValues.telefonoContactoDirecto);
    setHorarioLaboral(cleanValues.horarioLaboral);
    setErrors({});
  };
