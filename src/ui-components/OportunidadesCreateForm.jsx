...
export default function OportunidadesCreateForm(props) {
  ...
  const resetStateValues = () => {
    setMotivoBDT(initialValues.motivoBDT);
    setMotivoEmpresa(initialValues.motivoEmpresa);
    setStatus(initialValues.status);
    setMensaje(initialValues.mensaje);
    setVacanteID(initialValues.vacanteID);
    setEmpresaID(initialValues.empresaID);
    setStatusVisible(initialValues.statusVisible);
    setFechEntrevista(initialValues.fechEntrevista);
    setDireccionEmpresaEntrevista(initialValues.direccionEmpresaEntrevista);
    setHorarioEntrevista(initialValues.horarioEntrevista);
    setOcumentacionEntrevistad(initialValues.ocumentacionEntrevistad);
    ...
    setIdstep(initialValues.idstep);
    setCorreoEmpresa(initialValues.correoEmpresa);
    setCorreoBDT(initialValues.correoBDT);
